  ...
  FB.api({method: 'friends.getAppUsers'}, function(appFriendResponse) {
    ...
    FB.api('/me/friends', { fields: 'id, name, picture' }, function(friendResponse) {
      ...
      for (var k = 0; k < friends.length && k < 200; k++) {
        ...
        /*MICHAEL*/
        /*datos.tarjeta.push({ 
          "id_fb_amigo"  : friend.id,
          "name_amigo"   : friend.name,
          "picture_amigo": friend.picture 
        });*/
        /*MICHAEL*/
  ...
  FB.api({method: 'friends.getAppUsers'}, function(appFriendResponse) {
    ...
    FB.api('/me/friends', { fields: 'id, name, picture' }, function(friendResponse) {
      ...
      for (var k = 0; k < friends.length; k++) {
        ...
        friendIDs[k] = friend.id;
        //alert("nombre:"+friend.name+" id:"+friend.id);
        /*MICHAEL*/
        amigos.inf.push({ 
          "id_fb_amigo"  : friend.id,
          "name_amigo"   : friend.name,
...
function prueba2(){
  /*$.each(amigos.inf, function (k,value){
      alert("nombre:"+value.name_amigo+" id:"+id_fb_amigo);
    });*/
}